...
//        });
//
//        // BurayÄ± otomatik yapsÄ±n; 3 fotodan sonra kaydetsin direkt;
//
//        Button putFaces = (Button)findViewById(R.id.save_img);
//        putFaces.setOnClickListener(new View.OnClickListener(){
//            @Override
...
//    }
//
//    public boolean SaveImage() { // xml dosyasÄ±nÄ± kiÅŸinin adÄ±yla oluÅŸtur
//        File path = new File(Environment.getExternalStorageDirectory(), "TrainedData");
//        path.mkdirs();
//        String filename =isim.getText().toString()+".xml";
//        File file = new File(path, filename);
//        recognize.write(file.toString());// save de olabÃ¼lÃ¼
//        if(file.exists())
//            return true;
//        return false;
//
...
////        }catch(Exception e){
////
////            Toast.makeText(getApplicationContext(), "XML olusmadi", Toast.LENGTH_SHORT).show();
////            finish();
////        }
////        if(SaveImage())
////            return true;
